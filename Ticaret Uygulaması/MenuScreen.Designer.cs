namespace Ticaret_Uygulaması
{
    partial class MenuScreen
    {
        ...
        private void InitializeComponent()
        {
			...
			// filtre
			// 
			this.filtre.BackColor = System.Drawing.Color.Green;
			this.filtre.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.filtre.FormattingEnabled = true;
			this.filtre.Items.AddRange(new object[] {
            "fiyata göre sırala",
            "eklenme tarihine göre sırala"});
			this.filtre.Location = new System.Drawing.Point(12, 12);
			...
			this.flowLayoutPanel1.Size = new System.Drawing.Size(940, 684);
			this.flowLayoutPanel1.TabIndex = 2;
			// 
			// ekle
			// 
			this.ekle.Location = new System.Drawing.Point(984, 587);
			this.ekle.Name = "ekle";
